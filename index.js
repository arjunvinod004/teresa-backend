...
app.get('/save',(req,res)=>{
    const {PrmCmpId,PrmBrId,PrmName,PrmKycNo,PrmAddress,PrmIsIndian,PrmIsAbroad,PrmDueDate,PrmMobileNo,PrmPhoneNo,PrmEmail,PrmOccupation,PrmFunctionId,PrmOtherFunction,PrmDressTypeId,PrmDob,PrmContactTime,PrmIsCourier}=req.body
